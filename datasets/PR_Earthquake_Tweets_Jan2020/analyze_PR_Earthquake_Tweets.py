...
Este script realiza la carga de datos, limpieza, ingeniería de características y un análisis
exploratorio (EDA) completo, incluyendo visualizaciones estáticas e interactivas.
Todas las figuras se guardarán en el directorio 'analysis/'.
"""
...
# PyWaffle para gráficos de waffle
from pywaffle import Waffle

# WordCloud para visualización de texto
...
# -------------------------
# Paso 1: Eliminar columnas con valores nulos en su totalidad
df = df.dropna(axis=1, how='all')

# Paso 2: Eliminar columnas redundantes o duplicadas
...
# Paso 4: Crear la columna Total_Engagement
df["Total_Engagement"] = df["Reply_Count"] + df["Repost_Count"] + df["Like_Count"] + df["Bookmark_Count"]

# Paso 5: Convertir UTC_Time a datetime para análisis temporal
...
# Paso 8: Agregar características temporales
...
# Boxplot: Total Engagement filtrado por IQR (sin outliers extremos)
...
sns.countplot(
    ...
    hue="Tweet_Length_Category",  # igual que x para aplicar la paleta correctamente
    data=df_selected,
...
# -----------------------------
# Convertir Language a etiquetas numéricas para la correlación
...
# SECCIÓN F: Word Cloud - Palabras Frecuentes en los Tweets
custom_stopwords = {
    "https", "RT", "co", "amp",
